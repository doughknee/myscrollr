/**
 * /widgets — the full widget catalog, terminal-editorial style
...
function CatalogRow({
  ...
  return (
    ...
    // a mean tap target. The row delegates to the same toggle; the
    // button stays the accessible control (aria-pressed) and stops
