...
export const CATALOG_SNAPSHOT: Array<CatalogWidget> = [
  ...
  ...([
    ...
    ['news_cnn', 'CNN', 'news', '#cc0000', "CNN's top stories as they lead the homepage."],
    ['news_fox', 'Fox News', 'news', '#0c4da2', 'Top stories from Fox News, updated through the day.'],
    ['news_axios', 'Axios', 'news', '#1858e8', "Short, plain-English takes on the day's news."],
    ['news_politico', 'Politico', 'news', '#a51c30', 'Washington politics, campaigns and policy.'],
    ['news_abc', 'ABC News', 'news', '#0f6ecd', 'Top stories from ABC News.'],
    ['news_pbs', 'PBS NewsHour', 'news', '#2638c4', 'Headlines from PBS NewsHour.'],
