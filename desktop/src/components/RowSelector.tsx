  ...
  return (
    <div className={clsx("flex flex-col gap-1", className)}>
        ...
        {buttons.map(({ key, label, row }) => {
          ...
          return (
            <button
              ...
              disabled={disabled}
              className={clsx(
                "px-2 py-0.5 rounded text-ui-meta font-medium transition-all duration-150 active:scale-90",
                active
        ...
        {showAdd && (
          ...
          >
            <button
              ...
              className="flex items-center gap-0.5 px-2 py-0.5 rounded text-ui-meta font-medium border border-dashed border-edge/60 text-fg-3 hover:text-accent hover:border-accent/60 transition-all duration-150 active:scale-90 ml-0.5"
            >
              <Plus size={10} />
              Add
            </button>
      ...
      {disabled && disabledHint && (
        <p className="text-ui-meta text-fg-3">{disabledHint}</p>
      )}
    </div>
  );
}
