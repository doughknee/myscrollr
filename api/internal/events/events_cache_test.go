...
func TestInvalidateDashboardCache(t *testing.T) {
	...
	cacheKey := platform.RedisDashboardCachePrefix + userSub
	...
	platform.InvalidateDashboardCache(userSub)
...
func TestInvalidateUserCaches(t *testing.T) {
	...
	platform.InvalidateUserCaches(userSub)
...
func TestInvalidateIdempotent(t *testing.T) {
	...
	// Keys do not exist.
	platform.InvalidateDashboardCache("never_cached_user")
	platform.InvalidateUserCaches("never_cached_user")
