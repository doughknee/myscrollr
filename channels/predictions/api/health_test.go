...
// from `INTERNAL_PREDICTIONS_URL` produces the canonical /health/ready path.
...
func TestBuildReadyURL(t *testing.T) {
	cases := []struct {
		...
		{"http://predictions-service:3005", "http://predictions-service:3005/health/ready"},
		{"http://predictions-service:3005/", "http://predictions-service:3005/health/ready"},
		{"http://predictions-service:3005/health", "http://predictions-service:3005/health/ready"},
		{"http://predictions-service:3005/health/", "http://predictions-service:3005/health/ready"},
		{"http://predictions-service:3005/health/ready", "http://predictions-service:3005/health/ready"},
		{"http://predictions-service:3005/health/ready/", "http://predictions-service:3005/health/ready"},
	}
